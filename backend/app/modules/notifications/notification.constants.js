export const NOTIFICATION_EVENTS = Object.freeze({
  ...
  // City Parcel (separate module -- see constants/cityParcelWorkflow.js)
  CITY_PARCEL_BROADCAST: "CITY_PARCEL_BROADCAST",
  CITY_PARCEL_ASSIGNED: "CITY_PARCEL_ASSIGNED",
  CITY_PARCEL_STATUS_UPDATE: "CITY_PARCEL_STATUS_UPDATE",
  CITY_PARCEL_PICKUP_CODE: "CITY_PARCEL_PICKUP_CODE",
  CITY_PARCEL_DELIVERED: "CITY_PARCEL_DELIVERED",
  // The customer has a deadline to answer this one, so it must reach them
  // even when the app is closed.
  CITY_PARCEL_DECISION_NEEDED: "CITY_PARCEL_DECISION_NEEDED",
  CITY_PARCEL_RETURN_STARTED: "CITY_PARCEL_RETURN_STARTED",
  CITY_PARCEL_RETURNED: "CITY_PARCEL_RETURNED",
});
